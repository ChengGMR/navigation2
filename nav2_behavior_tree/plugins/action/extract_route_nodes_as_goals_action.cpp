...
ExtractRouteNodesAsGoals::ExtractRouteNodesAsGoals(const std::string& name, const BT::NodeConfiguration& conf) : BT::ActionNodeBase(name, conf) {}
...
BT_REGISTER_NODES(factory) {
    factory.registerNodeType<nav2_behavior_tree::ExtractRouteNodesAsGoals>("ExtractRouteNodesAsGoals");
}

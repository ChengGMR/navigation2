...
void GoalUpdater::createROSInterfaces() {
    ...
    node_->get_parameter_or<std::string>("goals_updater_topic", goals_updater_topic_new, "goals_update");
    ...
    if (goal_updater_topic_new != goal_updater_topic_ || !goal_sub_) {
        ...
        goal_sub_ = node_->create_subscription<geometry_msgs::msg::PoseStamped>(
            goal_updater_topic_, std::bind(&GoalUpdater::callback_updated_goal, this, _1), nav2::qos::StandardTopicQoS(), callback_group_);
    }
    if (goals_updater_topic_new != goals_updater_topic_ || !goals_sub_) {
        goals_updater_topic_ = goals_updater_topic_new;
        goals_sub_ = node_->create_subscription<nav_msgs::msg::Goals>(goals_updater_topic_, std::bind(&GoalUpdater::callback_updated_goals, this, _1),
                                                                      nav2::qos::StandardTopicQoS(), callback_group_);
    }
}

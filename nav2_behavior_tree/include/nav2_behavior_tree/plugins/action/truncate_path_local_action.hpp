...
class TruncatePathLocal : public BT::ActionNodeBase {
   public:
    ...
    static BT::PortsList providedPorts() {
        ...
        return {
            ...
            BT::OutputPort<nav_msgs::msg::Path>("output_path", "Path truncated to a certain distance around robot"),
   ...
   private:
     ...
     */
    static double poseDistance(const geometry_msgs::msg::PoseStamped& pose1, const geometry_msgs::msg::PoseStamped& pose2,

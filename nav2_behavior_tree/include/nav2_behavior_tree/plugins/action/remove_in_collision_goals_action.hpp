...
class RemoveInCollisionGoals : public BtServiceNode<nav2_msgs::srv::GetCosts> {
   public:
    ...
    static BT::PortsList providedPorts() {
        ...
        return providedBasicPorts({BT::InputPort<nav_msgs::msg::Goals>("input_goals", "Original goals to remove from"),
                                   ...
                                   BT::OutputPort<nav_msgs::msg::Goals>("output_goals", "Goals with in-collision goals removed"),

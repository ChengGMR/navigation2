   ...
   public:
    ...
    static BT::PortsList providedPorts() {
        return providedBasicPorts({
            ...
            BT::InputPort<geometry_msgs::msg::PoseStamped>("goal", "Goal pose of the path if using poses over IDs"),
            ...
            BT::OutputPort<builtin_interfaces::msg::Duration>("execution_duration", "Time taken to compute and track route"),
            BT::OutputPort<ActionResult::_error_code_type>("error_code_id", "The compute route error code"),
            BT::OutputPort<std::string>("error_msg", "The compute route error msg"),
            BT::OutputPort<uint16_t>("last_node_id", "ID of the previous node"),
            BT::OutputPort<uint16_t>("next_node_id", "ID of the next node"),
            BT::OutputPort<uint16_t>("current_edge_id", "ID of current edge"),
            ...
            BT::OutputPort<bool>("rerouted", "Whether the plan has rerouted"),
        });
    }

...
class ClearCostmapExceptRegionService : public BtServiceNode<nav2_msgs::srv::ClearCostmapExceptRegion> {
   public:
    ...
    static BT::PortsList providedPorts() {
        return providedBasicPorts({BT::InputPort<double>("reset_distance", 1, "Distance from the robot above which obstacles are cleared")});
    }
};
...
class ClearCostmapAroundRobotService : public BtServiceNode<nav2_msgs::srv::ClearCostmapAroundRobot> {
   public:
     ...
     */
    static BT::PortsList providedPorts() {
        return providedBasicPorts({BT::InputPort<double>("reset_distance", 1, "Distance from the robot under which obstacles are cleared")});
    }
};
...
class ClearCostmapAroundPoseService : public BtServiceNode<nav2_msgs::srv::ClearCostmapAroundPose> {
   public:
     ...
     */
    static BT::PortsList providedPorts() {
        return providedBasicPorts({BT::InputPort<geometry_msgs::msg::PoseStamped>("pose", "Pose around which to clear the costmap"),
                                   BT::InputPort<double>("reset_distance", 1.0, "Distance from the pose under which obstacles are cleared")});
    }
};

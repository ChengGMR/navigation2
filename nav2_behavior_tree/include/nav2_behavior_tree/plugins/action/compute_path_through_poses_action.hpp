   ...
   public:
    ...
    static BT::PortsList providedPorts() {
        ...
        return providedBasicPorts({
            BT::InputPort<nav_msgs::msg::Goals>("goals", "Destinations to plan through"),
            ...
            BT::OutputPort<int>("last_reached_index", "Index of the last reachable pose from requested list of poses"),
            BT::OutputPort<ActionResult::_error_code_type>("error_code_id", "The compute path through poses error code"),

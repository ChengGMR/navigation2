...
class RemovePassedGoals : public BT::ActionNodeBase {
   public:
    ...
    static BT::PortsList providedPorts() {
        ...
        return {BT::InputPort<nav_msgs::msg::Goals>("input_goals", "Original goals to remove viapoints from"),
                BT::OutputPort<nav_msgs::msg::Goals>("output_goals", "Goals with passed viapoints removed"),

...
class PathLongerOnApproach : public BT::DecoratorNode {
   public:
    ...
    static BT::PortsList providedPorts() {
        ...
        return {
            ...
            BT::InputPort<double>("length_factor", 2.0, "Length multiplication factor to check if the path is significantly longer"),
        };
    }
   ...
   private:
     ...
     */
    bool isNewPathLonger(nav_msgs::msg::Path& new_path, nav_msgs::msg::Path& old_path, double& length_factor);

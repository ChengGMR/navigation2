...
TEST_F(JsonTest, test_milliseconds) {
    ...
    auto milliseconds_test2 = exporter.fromJson(json["ms"])->first.cast<std::chrono::milliseconds>();
...
TEST_F(JsonTest, test_time) {
    ...
    auto const test_json = R"(json:{"__type": "builtin_interfaces::msg::Time", "sec": 1, "nanosec": 2})";
...
TEST_F(JsonTest, test_quaternion) {
    ...
    // Check the two-ways transform, i.e. "from_json"
    auto quaternion_test2 = exporter.fromJson(json["quaternion"])->first.cast<geometry_msgs::msg::Quaternion>();
    ...
    ASSERT_NO_THROW(quaternion_test3 = BT::convertFromString<geometry_msgs::msg::Quaternion>(test_json));
...
TEST_F(JsonTest, test_pose_stamped) {
    ...
    // Check the two-ways transform, i.e. "from_json"
    auto pose_stamped_test2 = exporter.fromJson(json["pose"])->first.cast<geometry_msgs::msg::PoseStamped>();
    ...
    ASSERT_NO_THROW(pose_stamped_test3 = BT::convertFromString<geometry_msgs::msg::PoseStamped>(test_json));
...
TEST_F(JsonTest, test_pose_stamped_vector) {
    ...
    ASSERT_EQ(json["poses"][0]["pose"]["orientation"]["__type"], "geometry_msgs::msg::Quaternion");
    ...
    ASSERT_EQ(json["poses"][1]["header"]["stamp"]["__type"], "builtin_interfaces::msg::Time");
    ...
    ASSERT_EQ(json["poses"][1]["pose"]["position"]["__type"], "geometry_msgs::msg::Point");
    ...
    ASSERT_EQ(json["poses"][1]["pose"]["orientation"]["__type"], "geometry_msgs::msg::Quaternion");
...
TEST_F(JsonTest, test_goals) {
    ...
    ASSERT_EQ(json["goals"]["goals"][0]["header"]["stamp"]["__type"], "builtin_interfaces::msg::Time");
    ...
    ASSERT_EQ(json["goals"]["goals"][0]["pose"]["orientation"]["__type"], "geometry_msgs::msg::Quaternion");
    ...
    ASSERT_EQ(json["goals"]["goals"][1]["header"]["stamp"]["__type"], "builtin_interfaces::msg::Time");
    ...
    ASSERT_EQ(json["goals"]["goals"][1]["pose"]["orientation"]["__type"], "geometry_msgs::msg::Quaternion");
    ...
    ASSERT_NO_THROW(goals_test3 = BT::convertFromString<nav_msgs::msg::Goals>(test_json));
...
TEST_F(JsonTest, test_path) {
    ...
    ASSERT_EQ(json["path"]["poses"][0]["header"]["stamp"]["__type"], "builtin_interfaces::msg::Time");
    ...
    ASSERT_EQ(json["path"]["poses"][0]["pose"]["position"]["__type"], "geometry_msgs::msg::Point");
    ...
    ASSERT_EQ(json["path"]["poses"][0]["pose"]["orientation"]["__type"], "geometry_msgs::msg::Quaternion");
    ...
    ASSERT_EQ(json["path"]["poses"][1]["header"]["stamp"]["__type"], "builtin_interfaces::msg::Time");
    ...
    ASSERT_EQ(json["path"]["poses"][1]["pose"]["position"]["__type"], "geometry_msgs::msg::Point");
    ...
    ASSERT_EQ(json["path"]["poses"][1]["pose"]["orientation"]["__type"], "geometry_msgs::msg::Quaternion");
    ...
    ASSERT_NO_THROW(path_test3 = BT::convertFromString<nav_msgs::msg::Path>(test_json));
...
TEST_F(JsonTest, test_waypoint_status) {
    ...
    ASSERT_EQ(json["waypoint_status"]["waypoint_pose"]["__type"], "geometry_msgs::msg::PoseStamped");
    ASSERT_EQ(json["waypoint_status"]["waypoint_pose"]["header"]["__type"], "std_msgs::msg::Header");
    ASSERT_EQ(json["waypoint_status"]["waypoint_pose"]["header"]["stamp"]["__type"], "builtin_interfaces::msg::Time");
    ...
    ASSERT_EQ(json["waypoint_status"]["waypoint_pose"]["pose"]["__type"], "geometry_msgs::msg::Pose");
    ASSERT_EQ(json["waypoint_status"]["waypoint_pose"]["pose"]["position"]["__type"], "geometry_msgs::msg::Point");
    ...
    ASSERT_EQ(json["waypoint_status"]["waypoint_pose"]["pose"]["orientation"]["__type"], "geometry_msgs::msg::Quaternion");
    ...
    // Check the two-ways transform, i.e. "from_json"
    auto waypoint_status_test2 = exporter.fromJson(json["waypoint_status"])->first.cast<nav2_msgs::msg::WaypointStatus>();
    ...
    ASSERT_EQ(waypoint_status_test.waypoint_pose.header.stamp.sec, waypoint_status_test2.waypoint_pose.header.stamp.sec);
    ASSERT_EQ(waypoint_status_test.waypoint_pose.header.stamp.nanosec, waypoint_status_test2.waypoint_pose.header.stamp.nanosec);
    ASSERT_EQ(waypoint_status_test.waypoint_pose.header.frame_id, waypoint_status_test2.waypoint_pose.header.frame_id);
    ASSERT_EQ(waypoint_status_test.waypoint_pose.pose.position.x, waypoint_status_test2.waypoint_pose.pose.position.x);
    ASSERT_EQ(waypoint_status_test.waypoint_pose.pose.position.y, waypoint_status_test2.waypoint_pose.pose.position.y);
    ASSERT_EQ(waypoint_status_test.waypoint_pose.pose.position.z, waypoint_status_test2.waypoint_pose.pose.position.z);
    ASSERT_EQ(waypoint_status_test.waypoint_pose.pose.orientation.x, waypoint_status_test2.waypoint_pose.pose.orientation.x);
    ASSERT_EQ(waypoint_status_test.waypoint_pose.pose.orientation.y, waypoint_status_test2.waypoint_pose.pose.orientation.y);
    ASSERT_EQ(waypoint_status_test.waypoint_pose.pose.orientation.z, waypoint_status_test2.waypoint_pose.pose.orientation.z);
    ASSERT_EQ(waypoint_status_test.waypoint_pose.pose.orientation.w, waypoint_status_test2.waypoint_pose.pose.orientation.w);
    ...
    ASSERT_NO_THROW(waypoint_status_test3 = BT::convertFromString<nav2_msgs::msg::WaypointStatus>(test_json));
...
TEST_F(JsonTest, test_waypoint_status_vector) {
    ...
    ASSERT_EQ(json["waypoint_status_vector"][0]["waypoint_pose"]["__type"], "geometry_msgs::msg::PoseStamped");
    ASSERT_EQ(json["waypoint_status_vector"][0]["waypoint_pose"]["header"]["__type"], "std_msgs::msg::Header");
    ASSERT_EQ(json["waypoint_status_vector"][0]["waypoint_pose"]["header"]["stamp"]["__type"], "builtin_interfaces::msg::Time");
    ...
    ASSERT_EQ(json["waypoint_status_vector"][0]["waypoint_pose"]["pose"]["__type"], "geometry_msgs::msg::Pose");
    ASSERT_EQ(json["waypoint_status_vector"][0]["waypoint_pose"]["pose"]["position"]["__type"], "geometry_msgs::msg::Point");
    ...
    ASSERT_EQ(json["waypoint_status_vector"][0]["waypoint_pose"]["pose"]["orientation"]["__type"], "geometry_msgs::msg::Quaternion");
    ...
    ASSERT_EQ(json["waypoint_status_vector"][1]["waypoint_pose"]["__type"], "geometry_msgs::msg::PoseStamped");
    ASSERT_EQ(json["waypoint_status_vector"][1]["waypoint_pose"]["header"]["__type"], "std_msgs::msg::Header");
    ASSERT_EQ(json["waypoint_status_vector"][1]["waypoint_pose"]["header"]["stamp"]["__type"], "builtin_interfaces::msg::Time");
    ...
    ASSERT_EQ(json["waypoint_status_vector"][1]["waypoint_pose"]["pose"]["__type"], "geometry_msgs::msg::Pose");
    ASSERT_EQ(json["waypoint_status_vector"][1]["waypoint_pose"]["pose"]["position"]["__type"], "geometry_msgs::msg::Point");
    ...
    ASSERT_EQ(json["waypoint_status_vector"][1]["waypoint_pose"]["pose"]["orientation"]["__type"], "geometry_msgs::msg::Quaternion");

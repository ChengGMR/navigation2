...
class PersistentSequenceTestFixture : public nav2_behavior_tree::BehaviorTreeTestFixture {
   public:
    static void SetUpTestCase() {
        ...
        factory_->registerNodeType<nav2_behavior_tree::PersistentSequenceNode>("PersistentSequence");
...
std::shared_ptr<BT::BehaviorTreeFactory> PersistentSequenceTestFixture::factory_ = nullptr;
...
TEST_F(PersistentSequenceTestFixture, test_behavior) {
    ...
    auto child0 = nav2_behavior_tree::get_node_from_tree<nav2_behavior_tree::DummyNode>(tree_, 0);
    auto child1 = nav2_behavior_tree::get_node_from_tree<nav2_behavior_tree::DummyNode>(tree_, 1);
    auto child2 = nav2_behavior_tree::get_node_from_tree<nav2_behavior_tree::DummyNode>(tree_, 2);

...
class NonblockingSequenceTestFixture : public nav2_behavior_tree::BehaviorTreeTestFixture {
   public:
    void SetUp() override {
        bt_node_ = std::make_shared<nav2_behavior_tree::NonblockingSequence>("nonblocking_sequence", *config_);
...
std::shared_ptr<nav2_behavior_tree::NonblockingSequence> NonblockingSequenceTestFixture::bt_node_ = nullptr;
std::shared_ptr<nav2_behavior_tree::DummyNode> NonblockingSequenceTestFixture::first_child_ = nullptr;
std::shared_ptr<nav2_behavior_tree::DummyNode> NonblockingSequenceTestFixture::second_child_ = nullptr;
std::shared_ptr<nav2_behavior_tree::DummyNode> NonblockingSequenceTestFixture::third_child_ = nullptr;

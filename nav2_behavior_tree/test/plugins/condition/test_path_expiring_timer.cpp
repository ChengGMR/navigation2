...
class PathExpiringTimerConditionTestFixture : public nav2_behavior_tree::BehaviorTreeTestFixture {
   public:
    void SetUp() {
        ...
        bt_node_ = std::make_shared<nav2_behavior_tree::PathExpiringTimerCondition>("time_expired", *config_);
    }
...
std::shared_ptr<nav2_behavior_tree::PathExpiringTimerCondition> PathExpiringTimerConditionTestFixture::bt_node_ = nullptr;

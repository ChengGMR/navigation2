...
class DistanceTraveledConditionTestFixture : public nav2_behavior_tree::BehaviorTreeTestFixture {
   public:
    void SetUp() {
        ...
        bt_node_ = std::make_shared<nav2_behavior_tree::DistanceTraveledCondition>("distance_traveled", *config_);
    }
...
std::shared_ptr<nav2_behavior_tree::DistanceTraveledCondition> DistanceTraveledConditionTestFixture::bt_node_ = nullptr;

...
class ShimNode : public nav2_behavior_tree::SingleTrigger {
   public:
    ShimNode(const std::string& name, const BT::NodeConfiguration& confi) : SingleTrigger(name, confi) {}
    ~ShimNode() {}
...
std::shared_ptr<ShimNode> SingleTriggerTestFixture::bt_node_ = nullptr;

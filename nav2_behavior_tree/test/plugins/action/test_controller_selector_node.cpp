...
class ControllerSelectorTestFixture : public ::testing::Test {
   public:
    static void SetUpTestCase() {
        ...
        factory_->registerBuilder<nav2_behavior_tree::ControllerSelector>("ControllerSelector", builder);
    }
...
rclcpp::executors::SingleThreadedExecutor::SharedPtr ControllerSelectorTestFixture::executor_ = nullptr;
...
TEST_F(ControllerSelectorTestFixture, test_custom_topic) {
    ...
    auto controller_selector_pub =
        node_->create_publisher<std_msgs::msg::String>("controller_selector_custom_topic_name", nav2::qos::LatchedPublisherQoS());
...
TEST_F(ControllerSelectorTestFixture, test_default_topic) {
    ...
    auto controller_selector_pub = node_->create_publisher<std_msgs::msg::String>("controller_selector", nav2::qos::LatchedPublisherQoS());
    controller_selector_pub->on_activate();

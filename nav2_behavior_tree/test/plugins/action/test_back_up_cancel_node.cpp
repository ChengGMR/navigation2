...
class CancelBackUpServer : public TestActionServer<nav2_msgs::action::BackUp> {
   ...
   protected:
    void execute(const typename std::shared_ptr<rclcpp_action::ServerGoalHandle<nav2_msgs::action::BackUp>> goal_handle) {
...
std::shared_ptr<nav2::ActionClient<nav2_msgs::action::BackUp>> CancelBackUpActionTestFixture::client_ = nullptr;

...
std::shared_ptr<nav2::ActionClient<nav2_msgs::action::FollowPath>> CancelControllerActionTestFixture::client_ = nullptr;
...
int main(int argc, char** argv) {
    ...
    std::thread server_thread([]() { rclcpp::spin(CancelControllerActionTestFixture::action_server_); });

...
class GoalCheckerSelectorTestFixture : public ::testing::Test {
   public:
    static void SetUpTestCase() {
        ...
        factory_->registerBuilder<nav2_behavior_tree::GoalCheckerSelector>("GoalCheckerSelector", builder);
    }
...
rclcpp::executors::SingleThreadedExecutor::SharedPtr GoalCheckerSelectorTestFixture::executor_ = nullptr;
...
TEST_F(GoalCheckerSelectorTestFixture, test_custom_topic) {
    ...
    auto goal_checker_selector_pub = node_->create_publisher<std_msgs::msg::String>("goal_checker_selector_custom_topic_name", qos);
...
TEST_F(GoalCheckerSelectorTestFixture, test_default_topic) {
    ...
    auto goal_checker_selector_pub = node_->create_publisher<std_msgs::msg::String>("goal_checker_selector", qos);
    goal_checker_selector_pub->on_activate();

...
class ToggleCollisionMonitorService : public TestService<nav2_msgs::srv::Toggle> {
   public:
    ToggleCollisionMonitorService() : TestService("/collision_monitor/toggle") {}
};
...
class ToggleCollisionMonitorTestFixture : public ::testing::Test {
   public:
    static void SetUpTestCase() {
        ...
        factory_->registerNodeType<nav2_behavior_tree::ToggleCollisionMonitorService>("ToggleCollisionMonitor");
    }
...
std::shared_ptr<ToggleCollisionMonitorService> ToggleCollisionMonitorTestFixture::server_ = nullptr;
BT::NodeConfiguration* ToggleCollisionMonitorTestFixture::config_ = nullptr;
std::shared_ptr<BT::BehaviorTreeFactory> ToggleCollisionMonitorTestFixture::factory_ = nullptr;
...
int main(int argc, char** argv) {
    ...
    ToggleCollisionMonitorTestFixture::server_ = std::make_shared<ToggleCollisionMonitorService>();
    std::thread server_thread([]() { rclcpp::spin(ToggleCollisionMonitorTestFixture::server_); });

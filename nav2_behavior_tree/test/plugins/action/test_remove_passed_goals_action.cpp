...
class RemovePassedGoalsTestFixture : public ::testing::Test {
   public:
    static void SetUpTestCase() {
        ...
        config_->blackboard->set("tf_buffer", transform_handler_->getBuffer());
...
std::shared_ptr<nav2_behavior_tree::TransformHandler> RemovePassedGoalsTestFixture::transform_handler_ = nullptr;
...
TEST_F(RemovePassedGoalsTestFixture, test_tick_remove_passed_goals_success_and_output_waypoint_statuses) {
    geometry_msgs::msg::Pose pose;
    pose.position.x = 0.25;
    pose.position.y = 0.0;
...
TEST_F(RemovePassedGoalsTestFixture, test_tick_remove_passed_goals_find_matching_waypoint_fail) {
    geometry_msgs::msg::Pose pose;
    pose.position.x = 0.25;
    pose.position.y = 0.0;

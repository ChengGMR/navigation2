...
class ClearCostmapExceptRegionServiceTestFixture : public ::testing::Test {
   public:
    static void SetUpTestCase() {
        ...
        // Put items on the blackboard
        config_->blackboard->set("node", node_);
        config_->blackboard->set<std::chrono::milliseconds>("server_timeout", std::chrono::milliseconds(10));
        config_->blackboard->set<std::chrono::milliseconds>("bt_loop_duration", std::chrono::milliseconds(10));
        config_->blackboard->set<std::chrono::milliseconds>("wait_for_service_timeout", std::chrono::milliseconds(1000));
        config_->blackboard->set("initial_pose_received", false);
        config_->blackboard->set("number_recoveries", 0);
...
nav2::LifecycleNode::SharedPtr ClearCostmapExceptRegionServiceTestFixture::node_ = nullptr;
...
nav2::LifecycleNode::SharedPtr ClearCostmapAroundRobotServiceTestFixture::node_ = nullptr;
...
class ClearCostmapAroundPoseService : public TestService<nav2_msgs::srv::ClearCostmapAroundPose> {
   public:
    ClearCostmapAroundPoseService() : TestService("clear_costmap_around_pose") {}
};
...
class ClearCostmapAroundPoseServiceTestFixture : public ::testing::Test {
   public:
    static void SetUpTestCase() {
        ...
        factory_->registerNodeType<nav2_behavior_tree::ClearCostmapAroundPoseService>("ClearCostmapAroundPose");
    }
...
nav2::LifecycleNode::SharedPtr ClearCostmapAroundPoseServiceTestFixture::node_ = nullptr;
std::shared_ptr<ClearCostmapAroundPoseService> ClearCostmapAroundPoseServiceTestFixture::server_ = nullptr;
BT::NodeConfiguration* ClearCostmapAroundPoseServiceTestFixture::config_ = nullptr;
std::shared_ptr<BT::BehaviorTreeFactory> ClearCostmapAroundPoseServiceTestFixture::factory_ = nullptr;
std::shared_ptr<BT::Tree> ClearCostmapAroundPoseServiceTestFixture::tree_ = nullptr;
...
int main(int argc, char** argv) {
    ...
    ClearCostmapExceptRegionServiceTestFixture::server_ = std::make_shared<ClearCostmapExceptRegionService>();
    std::thread server_thread_except_region([]() { rclcpp::spin(ClearCostmapExceptRegionServiceTestFixture::server_); });

    ClearCostmapAroundRobotServiceTestFixture::server_ = std::make_shared<ClearCostmapAroundRobotService>();
    std::thread server_thread_around_robot([]() { rclcpp::spin(ClearCostmapAroundRobotServiceTestFixture::server_); });

    ClearCostmapAroundPoseServiceTestFixture::server_ = std::make_shared<ClearCostmapAroundPoseService>();
    std::thread server_thread_around_pose([]() { rclcpp::spin(ClearCostmapAroundPoseServiceTestFixture::server_); });

...
class DriveOnHeadingActionServer : public TestActionServer<nav2_msgs::action::DriveOnHeading> {
   ...
   protected:
    void execute(const typename std::shared_ptr<rclcpp_action::ServerGoalHandle<nav2_msgs::action::DriveOnHeading>> goal_handle) override {
        nav2_msgs::action::DriveOnHeading::Result::SharedPtr result = std::make_shared<nav2_msgs::action::DriveOnHeading::Result>();
...
std::shared_ptr<DriveOnHeadingActionServer> DriveOnHeadingActionTestFixture::action_server_ = nullptr;
...
int main(int argc, char** argv) {
    ...
    std::thread server_thread([]() { rclcpp::spin(DriveOnHeadingActionTestFixture::action_server_); });

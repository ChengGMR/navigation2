...
class CancelWaitServer : public TestActionServer<nav2_msgs::action::Wait> {
   ...
   protected:
    void execute(const typename std::shared_ptr<rclcpp_action::ServerGoalHandle<nav2_msgs::action::Wait>> goal_handle) {
...
std::shared_ptr<nav2::ActionClient<nav2_msgs::action::Wait>> CancelWaitActionTestFixture::client_ = nullptr;

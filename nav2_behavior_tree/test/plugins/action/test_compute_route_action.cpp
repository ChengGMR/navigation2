...
class ComputeRouteActionServer : public TestActionServer<nav2_msgs::action::ComputeRoute> {
   ...
   protected:
    void execute(const typename std::shared_ptr<rclcpp_action::ServerGoalHandle<nav2_msgs::action::ComputeRoute>> goal_handle) override {
...
class ComputeRouteActionTestFixture : public ::testing::Test {
   public:
    static void SetUpTestCase() {
        ...
        factory_->registerBuilder<nav2_behavior_tree::ComputeRouteAction>("ComputeRoute", builder);
    }

...
class RemoveInCollisionGoalsSuccessService : public TestService<nav2_msgs::srv::GetCosts> {
   public:
    RemoveInCollisionGoalsSuccessService() : TestService("/global_costmap/get_cost_global_costmap") {}

    virtual void handle_service(const std::shared_ptr<rmw_request_id_t> request_header,
...
class RemoveInCollisionGoalsFailureService : public TestService<nav2_msgs::srv::GetCosts> {
   public:
    RemoveInCollisionGoalsFailureService() : TestService("/local_costmap/get_cost_local_costmap") {}
   ...
   public:
    static void SetUpTestCase() {
        ...
        BT::NodeBuilder builder = [](const std::string& name, const BT::NodeConfiguration& config) {
            return std::make_unique<nav2_behavior_tree::RemoveInCollisionGoals>(name, config);
        };

        factory_->registerBuilder<nav2_behavior_tree::RemoveInCollisionGoals>("RemoveInCollisionGoals", builder);
    }
...
std::shared_ptr<RemoveInCollisionGoalsSuccessService> RemoveInCollisionGoalsTestFixture::success_server_ = nullptr;
std::shared_ptr<RemoveInCollisionGoalsFailureService> RemoveInCollisionGoalsTestFixture::failure_server_ = nullptr;
...
TEST_F(RemoveInCollisionGoalsTestFixture, test_tick_remove_in_collision_goals_success_and_output_waypoint_statues) {
    // create tree
    std::string xml_txt =
        R"(
      <root BTCPP_format="4">
...
TEST_F(RemoveInCollisionGoalsTestFixture, test_tick_remove_in_collision_goals_find_matching_waypoint_fail) {
    // create tree
    std::string xml_txt =
        R"(
      <root BTCPP_format="4">
...
int main(int argc, char** argv) {
    ...
    RemoveInCollisionGoalsTestFixture::success_server_ = std::make_shared<RemoveInCollisionGoalsSuccessService>();
    std::thread success_server_thread([]() { rclcpp::spin(RemoveInCollisionGoalsTestFixture::success_server_); });

    RemoveInCollisionGoalsTestFixture::failure_server_ = std::make_shared<RemoveInCollisionGoalsFailureService>();
    std::thread failure_server_thread([]() { rclcpp::spin(RemoveInCollisionGoalsTestFixture::failure_server_); });

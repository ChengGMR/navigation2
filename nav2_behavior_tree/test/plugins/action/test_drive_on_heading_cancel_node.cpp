...
class CancelDriveOnHeadingServer : public TestActionServer<nav2_msgs::action::DriveOnHeading> {
   ...
   protected:
    void execute(const typename std::shared_ptr<rclcpp_action::ServerGoalHandle<nav2_msgs::action::DriveOnHeading>> goal_handle) {
...
class CancelDriveOnHeadingTestFixture : public ::testing::Test {
   public:
    static void SetUpTestCase() {
        ...
        client_ = rclcpp_action::create_client<nav2_msgs::action::DriveOnHeading>(node_, "drive_on_heading_cancel");

        BT::NodeBuilder builder = [](const std::string& name, const BT::NodeConfiguration& config) {
            return std::make_unique<nav2_behavior_tree::DriveOnHeadingCancel>(name, "drive_on_heading_cancel", config);
        };

        factory_->registerBuilder<nav2_behavior_tree::DriveOnHeadingCancel>("CancelDriveOnHeading", builder);
    }
...
std::shared_ptr<CancelDriveOnHeadingServer> CancelDriveOnHeadingTestFixture::action_server_ = nullptr;
std::shared_ptr<nav2::ActionClient<nav2_msgs::action::DriveOnHeading>> CancelDriveOnHeadingTestFixture::client_ = nullptr;
...
TEST_F(CancelDriveOnHeadingTestFixture, test_ports) {
    ...
    auto send_goal_options = rclcpp_action::Client<nav2_msgs::action::DriveOnHeading>::SendGoalOptions();
...
int main(int argc, char** argv) {
    ...
    std::thread server_thread([]() { rclcpp::spin(CancelDriveOnHeadingTestFixture::action_server_); });

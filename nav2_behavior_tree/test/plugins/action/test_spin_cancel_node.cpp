...
class CancelSpinServer : public TestActionServer<nav2_msgs::action::Spin> {
   ...
   protected:
    void execute(const typename std::shared_ptr<rclcpp_action::ServerGoalHandle<nav2_msgs::action::Spin>> goal_handle) {
...
std::shared_ptr<nav2::ActionClient<nav2_msgs::action::Spin>> CancelSpinActionTestFixture::client_ = nullptr;

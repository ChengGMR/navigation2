...
rclcpp::executors::SingleThreadedExecutor::SharedPtr SmootherSelectorTestFixture::executor_ = nullptr;
...
TEST_F(SmootherSelectorTestFixture, test_custom_topic) {
    ...
    auto smoother_selector_pub = node_->create_publisher<std_msgs::msg::String>("smoother_selector_custom_topic_name", qos);
...
TEST_F(SmootherSelectorTestFixture, test_default_topic) {
    ...
    auto smoother_selector_pub = node_->create_publisher<std_msgs::msg::String>("smoother_selector", qos);
    smoother_selector_pub->on_activate();

...
class ProgressCheckerSelectorTestFixture : public ::testing::Test {
   public:
    static void SetUpTestCase() {
        ...
        factory_->registerBuilder<nav2_behavior_tree::ProgressCheckerSelector>("ProgressCheckerSelector", builder);
    }
...
rclcpp::executors::SingleThreadedExecutor::SharedPtr ProgressCheckerSelectorTestFixture::executor_ = nullptr;
...
TEST_F(ProgressCheckerSelectorTestFixture, test_custom_topic) {
    ...
    auto progress_checker_selector_pub = node_->create_publisher<std_msgs::msg::String>("progress_checker_selector_custom_topic_name", qos);
...
TEST_F(ProgressCheckerSelectorTestFixture, test_default_topic) {
    ...
    auto progress_checker_selector_pub = node_->create_publisher<std_msgs::msg::String>("progress_checker_selector", qos);
    progress_checker_selector_pub->on_activate();

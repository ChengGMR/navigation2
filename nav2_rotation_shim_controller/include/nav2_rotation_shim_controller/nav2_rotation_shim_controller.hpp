...
class RotationShimController : public nav2_core::Controller {
   ...
   protected:
     ...
     */
    geometry_msgs::msg::TwistStamped computeRotateToHeadingCommand(const double& angular_distance, const geometry_msgs::msg::PoseStamped& pose,
     ...
     * @param pose Starting pose of robot
     */
    void isCollisionFree(const geometry_msgs::msg::TwistStamped& cmd_vel, const double& angular_distance_to_heading,

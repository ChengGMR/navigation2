...
TEST(SmootherTest, test_full_smoother) {
    nav2::LifecycleNode::SharedPtr node = std::make_shared<nav2::LifecycleNode>("SmacSmootherTest");
    ...
    nav2_costmap_2d::Costmap2D* costmap = new nav2_costmap_2d::Costmap2D(100, 100, 0.05, 0.0, 0.0, 0);

...
class UpsamplerConstrainedCostFunction : public ceres::SizedCostFunction<1, 1, 1> {
   public:
     ...
     */
    UpsamplerConstrainedCostFunction(const std::vector<Eigen::Vector2d>& path, const SmootherParams& params, const int& upsample_ratio, const int& i)
   ...
   protected:
     ...
     */
    inline void getCurvatureParams(const Eigen::Vector2d& pt, const Eigen::Vector2d& pt_p, const Eigen::Vector2d& pt_m,

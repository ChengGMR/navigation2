...
class AnalyticExpansion {
   public:
    ...
    struct AnalyticExpansionNodes {
        ...
        void setDirectionChanges(int changes) { direction_changes = changes; }
     ...
     */
    NodePtr tryAnalyticExpansion(const NodePtr& current_node, const NodeVector& coarse_check_goals, const NodeVector& fine_check_goals,
                                 const CoordinateVector& goals_coords, const NodeGetter& getter, int& iterations, int& closest_distance);

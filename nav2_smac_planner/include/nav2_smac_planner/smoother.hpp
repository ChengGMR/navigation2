...
struct BoundaryPoints {
     ...
     */
    BoundaryPoints(double& x_in, double& y_in, double& theta_in) : x(x_in), y(y_in), theta(theta_in) {}
...
class Smoother {
   ...
   protected:
     ...
     */
    void enforceStartBoundaryConditions(const geometry_msgs::msg::Pose& start_pose, nav_msgs::msg::Path& path,
     ...
     * @param reversing_segment Whether this path segment is in reverse
     */
    void enforceEndBoundaryConditions(const geometry_msgs::msg::Pose& end_pose, nav_msgs::msg::Path& path, const nav2_costmap_2d::Costmap2D* costmap,
     ...
     * @param reversing_segment Whether this path segment is in reverse
     */
    void findBoundaryExpansion(const geometry_msgs::msg::Pose& start, const geometry_msgs::msg::Pose& end, BoundaryExpansion& expansion,

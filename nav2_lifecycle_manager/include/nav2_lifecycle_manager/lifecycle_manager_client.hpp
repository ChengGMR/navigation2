...
class LifecycleManagerClient {
   public:
    ...
    explicit LifecycleManagerClient(const std::string& name, NodeT parent_node) {
        ...
        manager_client_ =
            nav2::interfaces::create_client<ManageLifecycleNodes>(parent_node, manage_service_name_, true /*creates and spins an internal executor*/);
        is_active_client_ = nav2::interfaces::create_client<std_srvs::srv::Trigger>(parent_node, active_service_name_,

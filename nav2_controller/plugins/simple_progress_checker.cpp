...
void SimpleProgressChecker::initialize(const nav2::LifecycleNode::WeakPtr& parent, const std::string& plugin_name) {
    ...
    double time_allowance_param = node->declare_or_get_parameter(plugin_name + ".movement_time_allowance", 10.0);
...
double SimpleProgressChecker::pose_distance(const geometry_msgs::msg::Pose& pose1, const geometry_msgs::msg::Pose& pose2) {

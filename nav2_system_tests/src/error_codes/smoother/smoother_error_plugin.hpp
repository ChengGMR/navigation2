...
class UnknownErrorSmoother : public nav2_core::Smoother {
   public:
    ...
    bool smooth(nav_msgs::msg::Path&, const rclcpp::Duration&) override { throw nav2_core::SmootherException("Unknown Smoother exception"); }
};

class TimeOutErrorSmoother : public UnknownErrorSmoother {
    bool smooth(nav_msgs::msg::Path&, const rclcpp::Duration&) { throw nav2_core::SmootherTimedOut("Smoother timedOut"); }
};

class SmoothedPathInCollision : public UnknownErrorSmoother {
    bool smooth(nav_msgs::msg::Path&, const rclcpp::Duration&) { throw nav2_core::SmoothedPathInCollision("Smoother path in collision"); }
};

class FailedToSmoothPath : public UnknownErrorSmoother {
    bool smooth(nav_msgs::msg::Path&, const rclcpp::Duration&) { throw nav2_core::FailedToSmoothPath("Failed to smooth path"); }
};

class InvalidPath : public UnknownErrorSmoother {
    bool smooth(nav_msgs::msg::Path&, const rclcpp::Duration&) { throw nav2_core::InvalidPath("Invalid path"); }
};

...
AssistedTeleopBehaviorTester* AssistedTeleopBehaviorTestFixture::assisted_teleop_behavior_tester = nullptr;
...
TEST_P(AssistedTeleopBehaviorTestFixture, testAssistedTeleopBehavior) {
    ...
    bool success = false;
    success = assisted_teleop_behavior_tester->defaultAssistedTeleopTest(test_params.lin_vel, test_params.ang_vel);
...
INSTANTIATE_TEST_SUITE_P(TestAssistedTeleopBehavior, AssistedTeleopBehaviorTestFixture, ::testing::Values(test_params[0], test_params[1]),
                         testNameGenerator);

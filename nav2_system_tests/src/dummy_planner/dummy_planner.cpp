...
DummyPlanner::DummyPlanner() : Node("DummyPlanner") {
    ...
    task_server_ = std::make_unique<nav2_behavior_tree::ComputePathToPoseTaskServer>(temp_node, false),
    task_server_->setExecuteCallback(std::bind(&DummyPlanner::computePlan, this, std::placeholders::_1));

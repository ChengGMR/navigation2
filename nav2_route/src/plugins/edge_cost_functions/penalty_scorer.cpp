...
void PenaltyScorer::configure(const nav2::LifecycleNode::SharedPtr node, const std::shared_ptr<tf2_ros::Buffer> /* tf_buffer */,
    ...
    nav2::declare_parameter_if_not_declared(node, getName() + ".penalty_tag", rclcpp::ParameterValue("penalty"));
...
bool PenaltyScorer::score(const EdgePtr edge, const RouteRequest& /* route_request */, const EdgeType& /* edge_type */, float& cost) {

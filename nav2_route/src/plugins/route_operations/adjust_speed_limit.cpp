...
void AdjustSpeedLimit::configure(const nav2::LifecycleNode::SharedPtr node,
    ...
    nav2::declare_parameter_if_not_declared(node, getName() + ".speed_limit_topic", rclcpp::ParameterValue("speed_limit"));
...
OperationResult AdjustSpeedLimit::perform(NodePtr /*node_achieved*/, EdgePtr edge_entered, EdgePtr /*edge_exited*/, const Route& /*route*/,

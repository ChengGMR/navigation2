...
void TimeMarker::configure(const nav2::LifecycleNode::SharedPtr node, std::shared_ptr<nav2_costmap_2d::CostmapSubscriber> /* costmap_subscriber */,
...
OperationResult TimeMarker::perform(NodePtr /*node_achieved*/, EdgePtr edge_entered, EdgePtr edge_exited, const Route& /*route*/,

 ...
 */
struct GraphAdaptor {
    explicit GraphAdaptor(const Graph& obj_) : obj(obj_) {}
...
typedef nanoflann::KDTreeSingleIndexAdaptor<nanoflann::L2_Simple_Adaptor<double, GraphAdaptor>, GraphAdaptor, DIMENSION, unsigned int> kd_tree_t;

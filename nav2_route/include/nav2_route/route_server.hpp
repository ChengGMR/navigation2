...
class RouteServer : public nav2::LifecycleNode {
   ...
   protected:
     ...
     */
    void populateActionResult(std::shared_ptr<ComputeRoute::Result> result, const Route& route, const nav_msgs::msg::Path& path,
     ...
     * @param planning_duration Time to create a valid route
     */
    void populateActionResult(std::shared_ptr<ComputeAndTrackRoute::Result> /*result*/, const Route& /*route*/, const nav_msgs::msg::Path& /*path*/,
                              const rclcpp::Duration& /*planning_duration*/);
     ...
     */
    void setRouteGraph(const std::shared_ptr<rmw_request_id_t> /*request_header*/,

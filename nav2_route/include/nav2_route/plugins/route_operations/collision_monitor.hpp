...
class CollisionMonitor : public RouteOperation {
   public:
     ...
     */
    OperationResult perform(NodePtr /*node*/, EdgePtr curr_edge, EdgePtr /*edge_exited*/, const Route& route,
                            const geometry_msgs::msg::PoseStamped& curr_pose, const Metadata* /*mdata*/) override;

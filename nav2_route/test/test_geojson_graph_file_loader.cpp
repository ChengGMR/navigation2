...
TEST(GeoJsonGraphFileLoader, test_missing_node_id) {
    ...
    GraphToIDMap graph_to_id_map;
    GeoJsonGraphFileLoader graph_file_loader;
    EXPECT_THROW(graph_file_loader.loadGraphFromFile(graph, graph_to_id_map, file_path), Json::exception);
    std::filesystem::remove(file_path);
}
...
TEST(GeoJsonGraphFileLoader, test_invalid_start_id_for_edge) {
    ...
    GraphToIDMap graph_to_id_map;
    GeoJsonGraphFileLoader graph_file_loader;
    EXPECT_THROW(graph_file_loader.loadGraphFromFile(graph, graph_to_id_map, file_path), std::runtime_error);
}
...
TEST(GeoJsonGraphFileLoader, sample_graph) {
    auto file_path = ament_index_cpp::get_package_share_directory("nav2_route") + "/graphs/sample_graph.geojson";
...
TEST(GeoJsonGraphFileLoader, invalid_file) {
    auto file_path = ament_index_cpp::get_package_share_directory("nav2_route") + "/test/test_graphs/invalid.json";
    GeoJsonGraphFileLoader graph_file_loader;
    Graph graph;
    GraphToIDMap graph_to_id_map;

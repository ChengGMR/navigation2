...
geometry_msgs::msg::Point linearInterpolation(const geometry_msgs::msg::Point& p1, const geometry_msgs::msg::Point& p2, const double target_dist) {
...
geometry_msgs::msg::PoseStamped getLookAheadPoint(double& lookahead_dist, const nav_msgs::msg::Path& transformed_plan,
    ...
    if (goal_pose_it == transformed_plan.poses.end()) {
        if (interpolate_after_goal) {
            ...
            // ahead distance
            const auto interpolated_position = linearInterpolation(last_pose_it->pose.position, projected_position, interpolation_dist);

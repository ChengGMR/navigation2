...
LifecycleServiceClient::LifecycleServiceClient(const string& lifecycle_node_name)
    ...
    , change_state_(lifecycle_node_name + "/change_state", node_, true /*creates and spins an internal executor*/)
    , get_state_(lifecycle_node_name + "/get_state", node_, true /*creates and spins an internal executor*/) {

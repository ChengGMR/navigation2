...
class TwistPublisher {
   public:
     ...
     */
    explicit TwistPublisher(nav2::LifecycleNode::SharedPtr node, const std::string& topic, const rclcpp::QoS& qos = nav2::qos::StandardTopicQoS())
        : topic_(topic) {
        using nav2::declare_parameter_if_not_declared;
        declare_parameter_if_not_declared(node, "enable_stamped_cmd_vel", rclcpp::ParameterValue{true});
   ...
   protected:
    ...
    nav2::Publisher<geometry_msgs::msg::TwistStamped>::SharedPtr twist_stamped_pub_;
};

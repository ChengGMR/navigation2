 ...
 */
inline double euclidean_distance(const geometry_msgs::msg::Point& pos1, const geometry_msgs::msg::Point& pos2, const bool is_3d = false) {
 ...
 */
inline double euclidean_distance(const geometry_msgs::msg::Pose& pos1, const geometry_msgs::msg::Pose& pos2, const bool is_3d = false) {
 ...
 * @return double L2 distance
 */
inline double euclidean_distance(const geometry_msgs::msg::PoseStamped& pos1, const geometry_msgs::msg::PoseStamped& pos2, const bool is_3d = false) {
 ...
 */
inline int find_next_matching_goal_in_waypoint_statuses(const std::vector<nav2_msgs::msg::WaypointStatus>& waypoint_statuses,
                                                        const geometry_msgs::msg::PoseStamped& goal) {
    auto itr = std::find_if(waypoint_statuses.begin(), waypoint_statuses.end(), [&goal](const nav2_msgs::msg::WaypointStatus& status) {
        return status.waypoint_pose == goal && status.waypoint_status == nav2_msgs::msg::WaypointStatus::PENDING;
    });
...
inline bool isPointInsidePolygon(const double px, const double py, const std::vector<PointT>& polygon) {
    ...
    for (j = 0; j < points_num; j++) {
        ...
        if ((py <= polygon[i].y) == (py > polygon[j].y)) {
            ...
            const double x_inter = polygon[i].x + (py - polygon[i].y) * (polygon[j].x - polygon[i].x) / (polygon[j].y - polygon[i].y);
 ...
 */
inline double distance_to_path_segment(const geometry_msgs::msg::Point& point, const geometry_msgs::msg::Pose& start,
 ...
 */
inline double cross_product_2d(const geometry_msgs::msg::Point& point, const geometry_msgs::msg::Pose& start, const geometry_msgs::msg::Pose& end) {
    const auto& p = point;
    const auto& a = start.position;
    const auto& b = end.position;

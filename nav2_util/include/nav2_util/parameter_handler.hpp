...
class ParameterHandler {
   public:
     ...
     */
    ParameterHandler(const nav2::LifecycleNode::SharedPtr& node, rclcpp::Logger& logger) : node_(node), logger_(logger) {}
   ...
   protected:
     ...
     */
    virtual rcl_interfaces::msg::SetParametersResult validateParameterUpdatesCallback(const std::vector<rclcpp::Parameter>& parameters) = 0;

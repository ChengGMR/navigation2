...
class CircleSegmentIntersectionTest : public ::testing::TestWithParam<CircleSegmentIntersectionParam> {};
...
INSTANTIATE_TEST_SUITE_P(InterpolationTest, CircleSegmentIntersectionTest,
                         testing::Values(
...
using linearInterpolationParam = std::tuple<std::pair<double, double>, std::pair<double, double>, double, std::pair<double, double> >;

class linearInterpolationTest : public ::testing::TestWithParam<linearInterpolationParam> {};
...
INSTANTIATE_TEST_SUITE_P(InterpolationTest, linearInterpolationTest,
                         testing::Values(
                             // Origin to the positive X axis
                             linearInterpolationParam{{0.0, 0.0}, {2.0, 0.0}, 1.0, {1.0, 0.0}},
                             // Origin to the negative X axis
                             linearInterpolationParam{{0.0, 0.0}, {-2.0, 0.0}, 1.0, {-1.0, 0.0}},
                             // Origin to the positive Y axis
                             linearInterpolationParam{{0.0, 0.0}, {0.0, 2.0}, 1.0, {0.0, 1.0}},
                             // Origin to the negative Y axis
                             linearInterpolationParam{{0.0, 0.0}, {0.0, -2.0}, 1.0, {0.0, -1.0}},
                             // non-origin to the X axis with non-unit circle, with the second point inside
                             linearInterpolationParam{{4.0, 0.0}, {-1.0, 0.0}, 2.0, {2.0, 0.0}},
                             // non-origin to the Y axis with non-unit circle, with the second point inside
                             linearInterpolationParam{{0.0, 4.0}, {0.0, -0.5}, 2.0, {0.0, 2.0}},
                             // origin to the positive X axis, on the circle
                             linearInterpolationParam{{2.0, 0.0}, {0.0, 0.0}, 2.0, {0.0, 0.0}},
                             // origin to the positive Y axis, on the circle
                             linearInterpolationParam{{0.0, 0.0}, {0.0, 2.0}, 2.0, {0.0, 2.0}},
                             // origin to the upper-right quadrant (3-4-5 triangle)
                             linearInterpolationParam{{0.0, 0.0}, {6.0, 8.0}, 5.0, {3.0, 4.0}},
                             // origin to the lower-left quadrant (3-4-5 triangle)
                             linearInterpolationParam{{0.0, 0.0}, {-6.0, -8.0}, 5.0, {-3.0, -4.0}},
                             // origin to the upper-left quadrant (3-4-5 triangle)
                             linearInterpolationParam{{0.0, 0.0}, {-6.0, 8.0}, 5.0, {-3.0, 4.0}},

...
TEST(TwistPublisher, Unstamped) {
    ...
    auto vel_publisher = std::make_unique<nav2_util::TwistPublisher>(pub_node, "cmd_vel", rclcpp::QoS(1));
    ...
    auto my_sub = sub_node->create_subscription<geometry_msgs::msg::Twist>("cmd_vel", [&](const geometry_msgs::msg::Twist msg) { sub_msg = msg; });
...
TEST(TwistPublisher, Stamped) {
    ...
    auto my_sub = sub_node->create_subscription<geometry_msgs::msg::TwistStamped>("cmd_vel",

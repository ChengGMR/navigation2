...
void Arc::append(nav_msgs::msg::Path& path, double spacing) const {
    ...
    tf2::Transform transform(tf2::Quaternion(tf2::Vector3(0.0, 0.0, 1.0), radians_per_step),
...
nav_msgs::msg::Path generate_path(geometry_msgs::msg::PoseStamped start, double spacing,

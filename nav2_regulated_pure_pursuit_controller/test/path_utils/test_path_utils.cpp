...
TEST(PathUtils, test_half_turn) {
    ...
    auto path = generate_path(start, spacing,
                              {
...
TEST(PathUtils, test_generate_all) {
    ...
    auto path = generate_path(start, spacing,
                              {
                                  std::make_unique<Straight>(1.0), std::make_unique<LeftTurn>(1.0), std::make_unique<RightTurn>(1.0),
                                  std::make_unique<LeftTurnAround>(1.0), std::make_unique<RightTurnAround>(1.0), std::make_unique<LeftCircle>(1.0),

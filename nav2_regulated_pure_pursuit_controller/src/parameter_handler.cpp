...
ParameterHandler::ParameterHandler(const nav2::LifecycleNode::SharedPtr& node, std::string& plugin_name, rclcpp::Logger& logger,
    ...
    declare_parameter_if_not_declared(node, plugin_name_ + ".min_distance_to_obstacle", rclcpp::ParameterValue(-1.0));
    ...
    declare_parameter_if_not_declared(node, plugin_name_ + ".use_cancel_deceleration", rclcpp::ParameterValue(false));
    declare_parameter_if_not_declared(node, plugin_name_ + ".cancel_deceleration", rclcpp::ParameterValue(3.2));
    ...
    declare_parameter_if_not_declared(node, plugin_name_ + ".interpolate_curvature_after_goal", rclcpp::ParameterValue(false));
    declare_parameter_if_not_declared(node, plugin_name_ + ".use_collision_detection", rclcpp::ParameterValue(true));
    declare_parameter_if_not_declared(node, plugin_name_ + ".stateful", rclcpp::ParameterValue(true));
    ...
    node->get_parameter(plugin_name_ + ".interpolate_curvature_after_goal", params_.interpolate_curvature_after_goal);

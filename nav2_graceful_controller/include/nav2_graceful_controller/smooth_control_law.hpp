...
class SmoothControlLaw {
   public:
     ...
     */
    SmoothControlLaw(double k_phi, double k_delta, double beta, double lambda, double slowdown_radius, double v_linear_min, double v_linear_max,
     ...
     */
    geometry_msgs::msg::Twist calculateRegularVelocity(const geometry_msgs::msg::Pose& target, const geometry_msgs::msg::Pose& current,
     ...
     */
    geometry_msgs::msg::Pose calculateNextPose(const double dt, const geometry_msgs::msg::Pose& target, const geometry_msgs::msg::Pose& current,
                                               const bool& backward = false);

...
class UndockRobotActionServer : public TestActionServer<nav2_msgs::action::UndockRobot> {
   public:
    UndockRobotActionServer() : TestActionServer("undock_robot") {}

   protected:
    void execute(const typename std::shared_ptr<rclcpp_action::ServerGoalHandle<nav2_msgs::action::UndockRobot>> goal_handle) override {
...
class UndockRobotActionTestFixture : public ::testing::Test {
   public:
    static void SetUpTestCase() {
        ...
        factory_->registerBuilder<opennav_docking_bt::UndockRobotAction>("UndockRobot", builder);
    }
...
std::shared_ptr<UndockRobotActionServer> UndockRobotActionTestFixture::action_server_ = nullptr;
...
int main(int argc, char** argv) {
    ...
    UndockRobotActionTestFixture::action_server_ = std::make_shared<UndockRobotActionServer>();

    std::thread server_thread([]() { rclcpp::spin(UndockRobotActionTestFixture::action_server_); });

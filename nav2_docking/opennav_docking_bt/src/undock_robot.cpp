...
UndockRobotAction::UndockRobotAction(const std::string& xml_tag_name, const std::string& action_name, const BT::NodeConfiguration& conf)
...
BT_REGISTER_NODES(factory) {
    ...
    factory.registerBuilder<opennav_docking_bt::UndockRobotAction>("UndockRobot", builder);
}

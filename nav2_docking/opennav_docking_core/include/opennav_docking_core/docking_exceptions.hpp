...
class DockingException : public std::runtime_error {
   public:
    explicit DockingException(const std::string& description) : std::runtime_error(description) {}
};
...
class DockNotInDB : public DockingException {
   public:
    explicit DockNotInDB(const std::string& description) : DockingException(description) {}
};
...
class DockNotValid : public DockingException {
   public:
    explicit DockNotValid(const std::string& description) : DockingException(description) {}
};
...
class FailedToStage : public DockingException {
   public:
    explicit FailedToStage(const std::string& description) : DockingException(description) {}
};
...
class FailedToDetectDock : public DockingException {
   public:
    explicit FailedToDetectDock(const std::string& description) : DockingException(description) {}
};
...
class FailedToControl : public DockingException {
   public:
    explicit FailedToControl(const std::string& description) : DockingException(description) {}
};
...
class FailedToCharge : public DockingException {
   public:
    explicit FailedToCharge(const std::string& description) : DockingException(description) {}
};

...
class BeamModel : public Laser {
   public:
     ...
     */
    BeamModel(double z_hit, double z_short, double z_max, double z_rand, double sigma_hit, double lambda_short, double chi_outlier, size_t max_beams,
              map_t* map);
...
class LikelihoodFieldModel : public Laser {
   public:
     ...
     * @brief BeamModel constructor
     */
    LikelihoodFieldModel(double z_hit, double z_rand, double sigma_hit, double max_occ_dist, size_t max_beams, map_t* map);
...
class LikelihoodFieldModelProb : public Laser {
   public:
     ...
     * @brief BeamModel constructor
     */
    LikelihoodFieldModelProb(double z_hit, double z_rand, double sigma_hit, double max_occ_dist, bool do_beamskip, double beam_skip_distance,
                             double beam_skip_threshold, double beam_skip_error_threshold, size_t max_beams, map_t* map);

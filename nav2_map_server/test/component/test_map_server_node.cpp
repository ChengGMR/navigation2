...
class MapServerTestFixture : public ::testing::Test {
   public:
    ...
    template <class T>
    typename T::Response::SharedPtr send_request(rclcpp::Node::SharedPtr node, typename rclcpp::Client<T>::SharedPtr client,
...
std::shared_ptr<nav2_util::LifecycleServiceClient> MapServerTestFixture::lifecycle_client_ = nullptr;

...
class VectorObjectServer : public nav2::LifecycleNode {
   ...
   protected:
     ...
     */
    void addShapesCallback(const std::shared_ptr<rmw_request_id_t> request_header, const std::shared_ptr<nav2_msgs::srv::AddShapes::Request> request,
     ...
     * @param response Service response
     */
    void getShapesCallback(const std::shared_ptr<rmw_request_id_t> request_header, const std::shared_ptr<nav2_msgs::srv::GetShapes::Request> request,
     ...
     * @param response Service response
     */
    void removeShapesCallback(const std::shared_ptr<rmw_request_id_t> request_header,

...
nav2::CallbackReturn CostmapFilterInfoServer::on_configure(const rclcpp_lifecycle::State& /*state*/) {
    RCLCPP_INFO(get_logger(), "Configuring");

    std::string filter_info_topic = get_parameter("filter_info_topic").as_string();

    publisher_ = this->create_publisher<nav2_msgs::msg::CostmapFilterInfo>(filter_info_topic, nav2::qos::LatchedPublisherQoS());
...
nav2::CallbackReturn CostmapFilterInfoServer::on_activate(const rclcpp_lifecycle::State& /*state*/) {
...
nav2::CallbackReturn CostmapFilterInfoServer::on_deactivate(const rclcpp_lifecycle::State& /*state*/) {
...
nav2::CallbackReturn CostmapFilterInfoServer::on_cleanup(const rclcpp_lifecycle::State& /*state*/) {
...
nav2::CallbackReturn CostmapFilterInfoServer::on_shutdown(const rclcpp_lifecycle::State& /*state*/) {

...
Scan::Scan(const nav2::LifecycleNode::WeakPtr& node, const std::string& source_name, const std::shared_ptr<tf2_ros::Buffer> tf_buffer,
...
void Scan::configure() {
    ...
    data_sub_ = node->create_subscription<sensor_msgs::msg::LaserScan>(source_topic, std::bind(&Scan::dataCallback, this, std::placeholders::_1),

...
CostmapTopicCollisionChecker::CostmapTopicCollisionChecker(CostmapSubscriber& costmap_sub, FootprintSubscriber& footprint_sub, std::string name)
    : name_(name), costmap_sub_(costmap_sub), footprint_sub_(&footprint_sub), collision_checker_(nullptr) {}

CostmapTopicCollisionChecker::CostmapTopicCollisionChecker(CostmapSubscriber& costmap_sub, std::string footprint_string, std::string name)
    : name_(name), costmap_sub_(costmap_sub), collision_checker_(nullptr) {
...
bool CostmapTopicCollisionChecker::isCollisionFree(const geometry_msgs::msg::Pose& pose, bool fetch_costmap_and_footprint) {
    try {
...
double CostmapTopicCollisionChecker::scorePose(const geometry_msgs::msg::Pose& pose, bool fetch_costmap_and_footprint) {
...
Footprint CostmapTopicCollisionChecker::getFootprint(const geometry_msgs::msg::Pose& pose, bool fetch_latest_footprint) {

...
TEST(DynParamTestNode, testDynParamsSet) {
    ...
    auto results1 = parameter_client->set_parameters_atomically({
        ...
        rclcpp::Parameter("footprint", "[[-0.325, -0.325], [-0.325, 0.325], [0.325, 0.325], [0.46, 0.0], [0.325, -0.325]]"),
    ...
    EXPECT_EQ(costmap->get_parameter("footprint").as_string(), "[[-0.325, -0.325], [-0.325, 0.325], [0.325, 0.325], [0.46, 0.0], [0.325, -0.325]]");

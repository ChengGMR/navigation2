...
class DummyCostmapSubscriber : public nav2_costmap_2d::CostmapSubscriber {
   public:
    DummyCostmapSubscriber(nav2::LifecycleNode::SharedPtr node, std::string& topic_name) : CostmapSubscriber(node, topic_name) {}
...
class DummyFootprintSubscriber : public nav2_costmap_2d::FootprintSubscriber {
   public:
    DummyFootprintSubscriber(nav2::LifecycleNode::SharedPtr node, std::string& topic_name, tf2_ros::Buffer& tf)
...
class TestCollisionChecker : public nav2::LifecycleNode {
   public:
    ...
    nav2::CallbackReturn on_cleanup(const rclcpp_lifecycle::State& /*state*/) {

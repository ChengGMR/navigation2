...
void addStaticLayer(nav2_costmap_2d::LayeredCostmap& layers, tf2_ros::Buffer& tf, nav2::LifecycleNode::SharedPtr node,
                    std::shared_ptr<nav2_costmap_2d::StaticLayer>& slayer, rclcpp::CallbackGroup::SharedPtr callback_group = nullptr) {
...
void addObstacleLayer(nav2_costmap_2d::LayeredCostmap& layers, tf2_ros::Buffer& tf, nav2::LifecycleNode::SharedPtr node,
                      std::shared_ptr<nav2_costmap_2d::ObstacleLayer>& olayer, rclcpp::CallbackGroup::SharedPtr callback_group = nullptr) {
...
void addRangeLayer(nav2_costmap_2d::LayeredCostmap& layers, tf2_ros::Buffer& tf, nav2::LifecycleNode::SharedPtr node,
                   std::shared_ptr<nav2_costmap_2d::RangeSensorLayer>& rlayer, rclcpp::CallbackGroup::SharedPtr callback_group = nullptr) {
...
void addObservation(std::shared_ptr<nav2_costmap_2d::ObstacleLayer> olayer, double x, double y, double z = 0.0, double ox = 0.0, double oy = 0.0,
                    double oz = MAX_Z, bool marking = true, bool clearing = true, double raytrace_max_range = 100.0, double raytrace_min_range = 0.0,
    ...
    *iter_z = z;
    ...
    nav2_costmap_2d::Observation obs(std::move(p), std::move(cloud), obstacle_max_range, obstacle_min_range, raytrace_max_range, raytrace_min_range);
    olayer->addStaticObservation(std::move(obs), marking, clearing);
}

void addInflationLayer(nav2_costmap_2d::LayeredCostmap& layers, tf2_ros::Buffer& tf, nav2::LifecycleNode::SharedPtr node,
                       std::shared_ptr<nav2_costmap_2d::InflationLayer>& ilayer, rclcpp::CallbackGroup::SharedPtr callback_group = nullptr) {
...
void addPluginContainerLayer(nav2_costmap_2d::LayeredCostmap& layers, tf2_ros::Buffer& tf, nav2::LifecycleNode::SharedPtr node,
                             std::shared_ptr<nav2_costmap_2d::PluginContainerLayer>& pclayer, std::string name,

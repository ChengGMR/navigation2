...
class CostmapFilterWrapper : public nav2_costmap_2d::CostmapFilter {
   public:
    ...
    void process(nav2_costmap_2d::Costmap2D&, int, int, int, int, const geometry_msgs::msg::Pose&) {}
    ...
    void setNode(const nav2::LifecycleNode::WeakPtr& node) { node_ = node; }
...
class TestNode : public ::testing::Test {
   public:
    ...
    template <class T>
    typename T::Response::SharedPtr send_request(nav2::LifecycleNode::SharedPtr node, typename nav2::ServiceClient<T>::SharedPtr client,

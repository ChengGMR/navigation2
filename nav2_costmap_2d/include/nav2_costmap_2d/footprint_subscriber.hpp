...
class FootprintSubscriber {
   public:
    ...
    explicit FootprintSubscriber(const NodeT& parent, const std::string& topic_name, tf2_ros::Buffer& tf, std::string robot_base_frame = "base_link",
        ...
        footprint_sub_ = nav2::interfaces::create_subscription<geometry_msgs::msg::PolygonStamped>(
            parent, topic_name, std::bind(&FootprintSubscriber::footprint_callback, this, std::placeholders::_1));
    }

...
class ClearCostmapService {
   ...
   private:
    ...
    nav2::ServiceServer<nav2_msgs::srv::ClearCostmapExceptRegion>::SharedPtr clear_except_service_;
    /**
     * @brief Callback to clear costmap except in a given region
     */
    void clearExceptRegionCallback(const std::shared_ptr<rmw_request_id_t> request_header,
    ...
    nav2::ServiceServer<nav2_msgs::srv::ClearCostmapAroundRobot>::SharedPtr clear_around_service_;
    /**
     * @brief Callback to clear costmap in a given region
     */
    void clearAroundRobotCallback(const std::shared_ptr<rmw_request_id_t> request_header,
    ...
    nav2::ServiceServer<nav2_msgs::srv::ClearCostmapAroundPose>::SharedPtr clear_around_pose_service_;
    /**
     * @brief Callback to clear costmap around a given pose
     */
    void clearAroundPoseCallback(const std::shared_ptr<rmw_request_id_t> request_header,
    ...
    nav2::ServiceServer<nav2_msgs::srv::ClearEntireCostmap>::SharedPtr clear_entire_service_;
    /**
     * @brief Callback to clear costmap
     */
    void clearEntireCallback(const std::shared_ptr<rmw_request_id_t> request_header,

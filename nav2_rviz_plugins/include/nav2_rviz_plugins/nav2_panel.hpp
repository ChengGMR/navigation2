...
class Nav2Panel : public rviz_common::Panel {
   ...
   private:
    ...
    geometry_msgs::msg::PoseStamped convert_to_msg(std::vector<double> pose, std::vector<double> orientation);
    ...
    nav2::ActionClient<nav2_msgs::action::FollowWaypoints>::SharedPtr waypoint_follower_action_client_;
    nav2::ActionClient<nav2_msgs::action::NavigateThroughPoses>::SharedPtr nav_through_poses_action_client_;

    // Navigation action feedback subscribers
    nav2::Subscription<nav2_msgs::action::NavigateToPose::Impl::FeedbackMessage>::SharedPtr navigation_feedback_sub_;
    nav2::Subscription<nav2_msgs::action::NavigateThroughPoses::Impl::FeedbackMessage>::SharedPtr nav_through_poses_feedback_sub_;
    nav2::Subscription<nav2_msgs::action::NavigateToPose::Impl::GoalStatusMessage>::SharedPtr navigation_goal_status_sub_;
    nav2::Subscription<nav2_msgs::action::NavigateThroughPoses::Impl::GoalStatusMessage>::SharedPtr nav_through_poses_goal_status_sub_;
    ...
    static inline QString getNavToPoseFeedbackLabel(nav2_msgs::action::NavigateToPose::Feedback msg = nav2_msgs::action::NavigateToPose::Feedback());
    static inline QString getNavThroughPosesFeedbackLabel(
        nav2_msgs::action::NavigateThroughPoses::Feedback = nav2_msgs::action::NavigateThroughPoses::Feedback());
    template <typename T>
...
class InitialThread : public QThread {
   ...
   public:
    ...
    explicit InitialThread(std::shared_ptr<nav2_lifecycle_manager::LifecycleManagerClient>& client_nav,

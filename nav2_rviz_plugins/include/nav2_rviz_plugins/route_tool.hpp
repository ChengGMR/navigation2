...
class RouteTool : public rviz_common::Panel {
   ...
   private:
    ...
    rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr graph_vis_publisher_;
    nav2::Subscription<geometry_msgs::msg::PointStamped>::SharedPtr clicked_point_subscription_;

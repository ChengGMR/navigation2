...
class FollowingServerShim : public FollowingServer {
   public:
    FollowingServerShim() : FollowingServer() {}
    ...
    virtual bool getRefinedPose(geometry_msgs::msg::PoseStamped& pose) { return FollowingServer::getRefinedPose(pose); }
    ...
    virtual bool rotateToObject(geometry_msgs::msg::PoseStamped&) { return true; }
    ...
    bool isGoalReached(const geometry_msgs::msg::PoseStamped& goal_pose) { return FollowingServer::isGoalReached(goal_pose); }

    void setDynamicPose(const geometry_msgs::msg::PoseStamped& pose) { detected_dynamic_pose_ = pose; }

    void setSkipOrientation(bool skip_orientation) { skip_orientation_ = skip_orientation; }
...
TEST(FollowingServerTests, ErrorExceptions) {
    ...
    auto pub = node2->create_publisher<geometry_msgs::msg::PoseStamped>("dynamic_pose", rclcpp::QoS(1));
    ...
    std::vector<std::string> error_ids{"TransformException", "FailedToDetectObject", "FailedToControl", "DockingException", "exception"};
...
TEST(FollowingServerTests, DynamicParams) {
    ...
    auto results = params->set_parameters_atomically(
        {rclcpp::Parameter("controller_frequency", 1.0), rclcpp::Parameter("detection_timeout", 2.0),
         rclcpp::Parameter("rotate_to_object_timeout", 3.0), rclcpp::Parameter("static_object_timeout", 4.0),
         rclcpp::Parameter("desired_distance", 5.0), rclcpp::Parameter("linear_tolerance", 6.0), rclcpp::Parameter("angular_tolerance", 7.0),
         rclcpp::Parameter("base_frame", std::string("test_base_frame")), rclcpp::Parameter("fixed_frame", std::string("test_fixed_frame")),
         rclcpp::Parameter("skip_orientation", false), rclcpp::Parameter("search_by_rotating", true), rclcpp::Parameter("search_angle", 8.0),

...
TEST(WaypointFollowerTest, WaitAtWaypoint) {
    ...
    std::unique_ptr<nav2_waypoint_follower::WaitAtWaypoint> waw(new nav2_waypoint_follower::WaitAtWaypoint);
...
TEST(WaypointFollowerTest, InputAtWaypoint) {
    ...
    std::unique_ptr<nav2_waypoint_follower::InputAtWaypoint> iaw(new nav2_waypoint_follower::InputAtWaypoint);
...
TEST(WaypointFollowerTest, PhotoAtWaypoint) {
    ...
    std::unique_ptr<nav2_waypoint_follower::PhotoAtWaypoint> paw(new nav2_waypoint_follower::PhotoAtWaypoint);

...
TEST(TrajectoryVisualizerTests, VisPathRepub) {
    ...
    auto my_sub =
        node->create_subscription<nav_msgs::msg::Path>("~/transformed_global_plan", [&](const nav_msgs::msg::Path msg) { received_path = msg; });
...
TEST(TrajectoryVisualizerTests, VisOptimalTrajectory) {
    ...
    auto my_sub = node->create_subscription<visualization_msgs::msg::MarkerArray>(
        "~/candidate_trajectories", [&](const visualization_msgs::msg::MarkerArray msg) { received_msg = msg; });
    rclcpp::executors::SingleThreadedExecutor executor;
    executor.add_node(node->get_node_base_interface());
...
TEST(TrajectoryVisualizerTests, VisOptimalPath) {
    ...
    nav_msgs::msg::Path received_path;
    auto my_sub = node->create_subscription<nav_msgs::msg::Path>("~/optimal_path", [&](const nav_msgs::msg::Path msg) { received_path = msg; });

...
class TestableSmootherCostFunction : nav2_constrained_smoother::SmootherCostFunction {
   public:
    TestableSmootherCostFunction(const Eigen::Vector2d& original_pos, double next_to_last_length_ratio, bool reversing,
        ...
        : SmootherCostFunction(original_pos, next_to_last_length_ratio, reversing, costmap, costmap_interpolator, params, costmap_weight) {}

    inline double getCurvatureResidual(const double& weight, const Eigen::Vector2d& pt, const Eigen::Vector2d& pt_next,
...
TEST_F(Test, testingCurvatureResidual) {
    ...
    TestableSmootherCostFunction fn(Eigen::Vector2d(1.0, 0.0), 1.0, false, &costmap,
                                    std::shared_ptr<ceres::BiCubicInterpolator<ceres::Grid2D<unsigned char>>>(),
    ...
    TestableSmootherCostFunction fn_no_min_turning_radius(Eigen::Vector2d(1.0, 0.0), 1.0, false, &costmap,
                                                          std::shared_ptr<ceres::BiCubicInterpolator<ceres::Grid2D<unsigned char>>>(),
